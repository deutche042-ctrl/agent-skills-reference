...
Standard structures for frequently needed visa support documents. Use these when creating documents from scratch with `create_docx.py` or as guidance when filling templates.

## Table of Contents

1. [Cover Letter](#cover-letter)
2. [Travel Itinerary](#travel-itinerary)
3. [Invitation Letter](#invitation-letter)
4. [Employment Certificate](#employment-certificate)
5. [Financial Support Statement](#financial-support-statement)
6. [Hotel Booking Summary](#hotel-booking-summary)
