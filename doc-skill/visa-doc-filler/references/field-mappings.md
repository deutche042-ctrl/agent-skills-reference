...
| English | Chinese | Japanese | Example Value | Notes |
|---------|------|--------|---------------|-------|
...
| Passport Expiry Date | 护照有效期 | 旅券有効期限 | 2030-03-14 | Must be >6 months from travel |
...
| English | Chinese | Japanese | Example Value |
|---------|------|--------|---------------|
