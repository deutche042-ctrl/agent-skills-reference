...
def scan_errors_only(filename: str) -> dict:
    """When LibreOffice is unavailable, only scan the file for existing formula errors (no recalculation)."""
    ...
    try:
        ...
        result = {
            ...
            "warning": "LibreOffice is not installed; formulas were not recalculated, only existing error values were scanned",
