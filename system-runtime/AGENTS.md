...
| 更新 Python server 依赖 | `../docker_build/images/python/requirements_server_py312.txt`、`setup.py`、`pyproject.toml`，并重建 Docker base layer |
...
├── requirements_ci.txt          # legacy Python 3.10 dependency inventory; no longer baked into the image
